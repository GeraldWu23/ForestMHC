...
if __name__ == '__main__':
    ...
    testExtractor = Extractor(['hydropathy','mass','is_aromatic','sparse'],aali)  # aali from extractor_local.py
    result_vanilla = testExtractor.extract_from_list(['SADEPMTTF','DSETRRLYY','SSDRKGGSY'])  # 3*(3*(1+1+20+1))   
